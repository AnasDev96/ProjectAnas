...
public class StopsDaoTest {
    ...
    public StopsDaoTest() throws IOException {
    ...
    /**
     * Test of selectAll method, of class StopsDao.
     */
    @Test
    public void testSelectAll() throws Exception {
        System.out.println("selectAll");
        StopsDao instance = StopsDao.getInstance();
        List<StopsDto> expResult = listStop;
    ...
    public void testSelectAllFalse() throws Exception {
        ...
        StopsDao instance = StopsDao.getInstance();
        listStop.add(new StopsDto(43,55,54));
        List<StopsDto> expResult = listStop;
        List<StopsDto> result = instance.selectAll();
